...
namespace ServerDevcommands {
  ...
  public class BindCommand {
    ...
    public BindCommand() {
      new Terminal.ConsoleCommand("bind", "[keycode,modifier1,modifier2,...] [command] [parameters] - Binds a key (with modifier keys) to a command.", delegate (Terminal.ConsoleEventArgs args) {
      ...
      new Terminal.ConsoleCommand("printbinds", "Prints all key binds.", delegate (Terminal.ConsoleEventArgs args) {
