...
public class InventoryCommand {
  private static readonly List<string> Operations = new() { "clear", "level", "refill", "repair", "upgrade" };
  private static readonly List<string> Targets = new() { "all", "hand", "worn" };
  private static readonly HashSet<ItemDrop.ItemData.ItemType> HandTypes = new() {
  ...
  private static readonly HashSet<ItemDrop.ItemData.ItemType> ArmorTypes = new() {
