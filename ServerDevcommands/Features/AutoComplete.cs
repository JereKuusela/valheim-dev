...
{
  private static readonly Dictionary<string, OptionsFetcher> OptionsFetchers = new();
  private static readonly Dictionary<string, NamedOptionsFetchers> OptionsNamedFetchers = new();
